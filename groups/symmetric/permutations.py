...
class Pgroup():
    ...
    def info(self
        ...
        #Basic information
        table = [i.info() for i in self.elements]
        print(tabulate(table,["Element","Order","Inverse","Cycles","T-pos"],"grid"))
        #Conjugacy Classes
        self.conjugacy_classes()
        print("Conjugacy Classes : ",end="")
        for i in self.conjugacy_classes:
            print(i,'\n                    ',end="")
        #Subgroups
